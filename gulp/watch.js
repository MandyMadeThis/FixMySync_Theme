...
gulp.task('watch', function () {
  gulp.watch(paths.styles.watch, ['reload-on-css'])
  gulp.watch(paths.scripts.watch, ['reload-on-js'])
  gulp.watch(paths.vendor.watch, ['reload-on-js'])
  gulp.watch(paths.php.watch, ['reload-on-php'])
